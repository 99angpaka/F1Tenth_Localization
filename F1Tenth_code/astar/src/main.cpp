...
vector <double> startPointDirection;
...
void MapCallback(const nav_msgs::OccupancyGrid& msg)
{
    ...
    // imwrite("/home/gromit/catkin_ws/src/astar/binary_map.png", Map);
    // imwrite("/home/gromit/catkin_ws/src/astar/mask.png", Mask);
...
void StartPointCallback(const geometry_msgs::PoseWithCovarianceStamped& msg)
{
    ...
    startPointDirection = {msg.pose.pose.orientation.x, msg.pose.pose.orientation.y,
...
int main(int argc, char * argv[])
{
    ...
    while(ros::ok())
    {
        if(start_flag)
        {
            ...
            astar.PathPlanning(startPoint, startPointDirection, targetPoint, PathList);
            if(!PathList.empty())
            {
