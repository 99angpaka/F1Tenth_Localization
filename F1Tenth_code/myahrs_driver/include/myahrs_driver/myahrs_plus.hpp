 ...
 **********************************************************************************************************/
    ...
    public:
        ...
        public:
            SerialPort(const char* port="COM3", unsigned int brate=57600
    ...
    public:
        ...
        public:
            SerialPort(const char* port = "", unsigned int brate=57600)
            : port_name(port), baudrate(brate)
            , port_fd(-1)
            {
            }
 ...
 **********************************************************************************************************/
    ...
    public:
        iMyAhrsPlus(std::string port_name="", unsigned int baudrate=57600)
    ...
    public:
        MyAhrsPlus(std::string port="", unsigned int baudrate=57600)
