...
AckermannToVesc::AckermannToVesc(ros::NodeHandle nh, ros::NodeHandle private_nh)
{
  ...
  vesc_state_sub_ = nh.subscribe("sensors/core", 1, &AckermannToVesc::vescStateCallback, this);
  // ackermann_joy_sub_ = nh.subscribe("/vesc/low_level/ackermann_cmd_mux/input/teleop", 10, &AckermannToVesc::joyackermannCmdCallback, this);
  //ackermann_nav_sub_ = nh.subscribe("/vesc/low_level/ackermann_cmd_mux/input/navigation", 10, &AckermannToVesc::navCmdCallback, this);
}
...
typedef vesc_msgs::VescStateStamped::ConstPtr VescStatePtr;
void AckermannToVesc::vescStateCallback(const VescStatePtr& cmd)
{
  speed_to_erpm_offset_ = cmd->state.speed * -1;
}

// void AckermannToVesc::joyackermannCmdCallback(const AckermannMsgPtr& cmd)
// {
//   // calc vesc electric RPM (speed)
//   std_msgs::Float64::Ptr erpm_msg(new std_msgs::Float64);
//   erpm_msg->data = speed_to_erpm_gain_ * cmd->drive.speed + speed_to_erpm_offset_;
...
// void AckermannToVesc::navCmdCallback(const AckermannMsgPtr& cmd)
// {
//   // calc vesc electric RPM (speed)
//   std_msgs::Float64::Ptr erpm_msg(new std_msgs::Float64);
//   erpm_msg->data = speed_to_erpm_gain_ * cmd->drive.speed + speed_to_erpm_offset_;
