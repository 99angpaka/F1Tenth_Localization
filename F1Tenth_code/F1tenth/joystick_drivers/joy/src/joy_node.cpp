...
public:
  ...
  int main(int argc, char **argv)
  {
    ...
    nh_param.param<bool>("sticky_buttons", sticky_buttons_, true);
        ...
        if (publish_now) {
          ...
          if (sticky_buttons_ == true) {
            ...
            // For Bluetooth connection
              ...
              sensor_msgs::Joy bluetooth_joy_msg;
              bluetooth_joy_msg.header = sticky_buttons_joy_msg.header;
              bluetooth_joy_msg.axes.resize(sticky_buttons_joy_msg.axes.size());
              bluetooth_joy_msg.axes[0] = sticky_buttons_joy_msg.axes[0];
              bluetooth_joy_msg.axes[1] = sticky_buttons_joy_msg.axes[1];
              bluetooth_joy_msg.axes[2] = sticky_buttons_joy_msg.axes[5];
              bluetooth_joy_msg.axes[3] = sticky_buttons_joy_msg.axes[2];
              bluetooth_joy_msg.axes[4] = sticky_buttons_joy_msg.axes[3];
              bluetooth_joy_msg.axes[5] = sticky_buttons_joy_msg.axes[4];
              bluetooth_joy_msg.axes[6] = sticky_buttons_joy_msg.axes[6];
              bluetooth_joy_msg.axes[7] = sticky_buttons_joy_msg.axes[7];
              bluetooth_joy_msg.buttons.resize(sticky_buttons_joy_msg.buttons.size());
              bluetooth_joy_msg.buttons[0] = sticky_buttons_joy_msg.buttons[0];
              bluetooth_joy_msg.buttons[1] = sticky_buttons_joy_msg.buttons[1];
              bluetooth_joy_msg.buttons[2] = sticky_buttons_joy_msg.buttons[3];
              bluetooth_joy_msg.buttons[3] = sticky_buttons_joy_msg.buttons[4];
              bluetooth_joy_msg.buttons[4] = sticky_buttons_joy_msg.buttons[6];
              bluetooth_joy_msg.buttons[5] = sticky_buttons_joy_msg.buttons[7];
              bluetooth_joy_msg.buttons[6] = sticky_buttons_joy_msg.buttons[2];
              bluetooth_joy_msg.buttons[7] = sticky_buttons_joy_msg.buttons[5];
              bluetooth_joy_msg.buttons[8] = sticky_buttons_joy_msg.buttons[8];
              bluetooth_joy_msg.buttons[9] = sticky_buttons_joy_msg.buttons[9];
              bluetooth_joy_msg.buttons[10] = sticky_buttons_joy_msg.buttons[10];
            
            // if (bluetooth_joy_msg.buttons[4] == 1){
            //   pub_.publish(bluetooth_joy_msg);
            // }
            // else if (bluetooth_joy_msg.buttons[0] == 1){
            //   emergency_mode_ = true;
            //   pub_.publish(bluetooth_joy_msg);
            // }
            // else if(bluetooth_joy_msg.buttons[0] == 0 && emergency_mode_){
